...
draw.text((80, 105), "Protocolo de Peptidos  -  Semana 1", font=font_subtitle, fill=light_gray)
draw.text((80, 140), "Tarjeta Personal de Dosis", font=font_tiny, fill="#555570")
rrect(draw, [W-185, 50, W-45, 190], 16, gold)
draw.text((W-172, 58), "SEMANA", font=font_tag, fill="#080810")
...
peptides = [
    ...
    },
    {
        "name": "MOTS-C",
        "vial": "Frasco 5mg",
        "dose": "10 unidades  (1mg/dia)",
        "freq": "Diario",
        "time": "Manana o Pre-Entrenamiento",
        "time_color": "#FF8C42",
        "tag": "DIARIO · PRE-ENT",
        "tag_color": "#FF8C42",
        "tag_bg": "#2A1000",
...
for i, p in enumerate(peptides):
    ...
    col1_x = x1 + 40
    draw.text((col1_x, y + 108), "DOSIS", font=font_tiny, fill="#666680")
    draw.text((col1_x, y + 132), p["dose"], font=font_value_gold, fill=gold_light)

    col2_x = x1 + 340
    draw.text((col2_x, y + 108), "FRECUENCIA", font=font_tiny, fill="#666680")
    draw.text((col2_x, y + 132), p["freq"], font=font_value, fill=white)

    draw.line([(x1 + 18, y + 182), (x2 - 18, y + 182)], fill=divider, width=1)
    draw.text((col1_x, y + 196), "Horario:  " + p["time"], font=font_small, fill=p["time_color"])
    draw.text((col2_x + 40, y + 196), "Jeringa de insulina", font=font_small, fill="#444460")
...
draw.text((60, footer_y + 18), "Todas las dosis con jeringa de insulina (100 unidades)", font=font_small, fill=light_gray)
draw.text((60, footer_y + 48), "Refrigerar todos los peptidos despues de reconstitur", font=font_small, fill=light_gray)
draw.text((60, footer_y + 75), "Uso personal - Seguir el protocolo indicado", font=font_tiny, fill="#444455")

img.save("/app/peptide_week1_es.png", quality=98)
print("Done")
